...
echo "=== Zammad Docker Setup (Externe PostgreSQL) ==="

# --- Vraag DB gegevens ---
read -p "Database host (bijv. 192.168.2.89): " DB_HOST
...
# -----------------------------
# 2. docker-compose.yml aanmaken
#    (Volledig gepatcht — geen PostgreSQL container)
# -----------------------------
...
services:
  ...
  zammad-elasticsearch:
    image: elasticsearch:${ELASTICSEARCH_VERSION:-8.19.6}
    restart: ${RESTART:-always}
    volumes:
...
echo "[OK] docker-compose.yml aangemaakt"

echo ""
echo "==========================================="
echo " Zammad installatie gereed!"
echo " Start nu met:  docker compose up -d"
echo "==========================================="
